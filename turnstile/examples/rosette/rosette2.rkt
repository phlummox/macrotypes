...
(provide (rename-out [ro:#%module-begin #%module-begin] 
         ...
         CListof Listof CVectorof CParamof ; TODO: symbolic Param
         CUnit Unit
         CNegInt NegInt
         CZero Zero
         CPosInt PosInt
...
(define-rosette-primop sub1 : (Ccase-> (C→ CNegInt CNegInt)
                                       ...
                                       (C→ CInt CInt)
                                       (C→ Int Int)))
(define-rosette-primop + : (Ccase-> (C→ CZero)
                                    (C→ CNat CNat CNat)
...
(define-rosette-primop - : (Ccase-> (C→ CInt CInt)
                                    (C→ CInt CInt CInt)
                                    (C→ CInt CInt CInt CInt)
                                    (C→ CInt CInt CInt CInt CInt)
                                    (C→ Int Int)
...
(define-rosette-primop * : (Ccase-> (C→ CNat CNat CNat)
                                    ...
                                    (C→ Num Num Num Num)
                                    (C→ Num Num Num Num Num)))
(define-rosette-primop / : (Ccase-> (C→ CNum CNum)
                                    (C→ CNum CNum CNum)
                                    (C→ CNum CNum CNum CNum)
                                    (C→ Num Num)
                                    (C→ Num Num Num)
...
(define-rosette-primop abs : (Ccase-> (C→ CPosInt CPosInt)
                                      ...
                                      (C→ CNum CNum)
                                      (C→ Num Num)))
(define-rosette-primop max : (Ccase-> (C→ CInt CInt CInt)
                                      (C→ CInt CInt CInt CInt)
                                      (C→ CNum CNum CNum)
                                      (C→ CNum CNum CNum CNum)
                                      (C→ Int Int Int)
                                      ...
                                      (C→ Num Num Num)
                                      (C→ Num Num Num Num)))
(define-rosette-primop min : (Ccase-> (C→ CInt CInt CInt)
                                      (C→ CInt CInt CInt CInt)
                                      (C→ CNum CNum CNum)
                                      (C→ CNum CNum CNum CNum)
                                      (C→ Int Int Int)
...
(define-rosette-primop floor : (Ccase-> (C→ CNum CNum)
                                        (C→ Num Num)))
(define-rosette-primop ceiling : (Ccase-> (C→ CNum CNum)
                                          (C→ Num Num)))
...
(define-rosette-primop expt : (Ccase-> (C→ CNum CZero CPosInt)
                                       (C→ Num Zero PosInt)
                                       (C→ CInt CInt CInt)
                                       (C→ Int Int Int)
                                       (C→ CNum CNum CNum)
...
(define-rosette-primop model : (C→ CSolution (CHashTable Any Any)))
